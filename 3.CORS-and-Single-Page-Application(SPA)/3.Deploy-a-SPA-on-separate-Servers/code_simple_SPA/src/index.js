...
function getFunc() {
    ...
    fetch("https://sandersolutions.dk/week39/api/person/2")
        .then(res => res.json())
        .then(data => {
...
function postFunc() {
    ...
    fetch("https://sandersolutions.dk/week39/api/person/", options);
};
...
function putFunc() {
    ...
    fetch("https://sandersolutions.dk/week39/api/person/2", options);
};
...
function deleteFunc() {
    ...
    fetch("https://sandersolutions.dk/week39/api/person/3", options);
};